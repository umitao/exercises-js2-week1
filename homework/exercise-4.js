...
var restaurantFinderApplication = {
  ...
  findAvailableRestaurants: function (numberOfPeople) {
    ...
    var availableRestaurantNames = availableRestaurants.map(
      (names) => names.name
    );
    return availableRestaurantNames;
  },
  findRestaurantServingDish: function (dishName) {
    var isServingDish = this.restaurants.filter(function (restaurant) {
      return restaurant.menu.includes(dishName);
    });
    var restaurantNamesServingDishes = isServingDish.map(function (restaurant) {
      return restaurant.name;
    });
    return restaurantNamesServingDishes;
  },
